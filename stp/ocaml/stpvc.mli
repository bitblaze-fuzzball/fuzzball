...
val get_whole_counterexample : vc -> whole_ce
  (** @return an object representing a counterexample valuation *)

val get_term_from_counterexample : vc -> exp -> whole_ce -> exp
  (** @return the value of a term in a counterexample valuation *)
