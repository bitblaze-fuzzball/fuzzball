...
let opt_branch_preference_malloc = Hashtbl.create 10
let opt_branch_preference_free = Hashtbl.create 10
let opt_branch_preference_unchecked = Hashtbl.create 10
let opt_learn_branch_preference = ref false
let opt_learning_rate = ref 0.1
let opt_reset_threshold = ref 1000000000000L
