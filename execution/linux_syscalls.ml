...
object(self)
  ...
  method private handle_linux_syscall () =
    ...
    (let syscall_num = Int64.to_int (get_reg callnum_reg) and
	 ...
	 | (ARM, 374) -> uh "Check whether ARM sendmmsg syscall matches x86"
