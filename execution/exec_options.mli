...
val opt_branch_preference : (int64, float) Hashtbl.t
val opt_branch_preference_malloc : (int64, float) Hashtbl.t
val opt_branch_preference_free : (int64, float) Hashtbl.t
val opt_branch_preference_unchecked : (int64, int64) Hashtbl.t
val opt_learn_branch_preference : bool ref
val opt_learning_rate : float ref
val opt_reset_threshold : int64 ref
