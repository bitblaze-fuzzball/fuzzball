...
class no_influence_manager = object(self)
  ...
  method take_measure_eip (es:V.exp list) = ()
  method take_measure_expr (e1:V.exp) (e2:V.exp) = ()
  method measure_influence_common (dl:V.decl list)
    (a:(V.var * V.exp) list) (e1:V.exp) (es:V.exp list) = 0.0
  method measure_influence (es:V.exp list) = 0.0
  ...
  method measure_point_influence (s:string) (es:V.exp list) = ()
  method maybe_measure_influence_deref (e:V.exp) = ()
  method measure_influence_rep = ()
  method measure_influence_expr (es:V.exp list) = ()
